...
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lim_regions.bed > GR_lim_intersect_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lim_regions.bed > GR_lim_intersect_us.bed #######################
...
############# find closest using bedtools
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lim_regions_6am.bed > GR_lim_intersect_6am_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lim_regions_6am.bed > GR_lim_intersect_6am_us.bed #######################
...
############# find closest using bedtools
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lim_regions_6pm.bed > GR_lim_intersect_6pm_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lim_regions_6pm.bed > GR_lim_intersect_6pm_us.bed #######################
...
############# find closest using bedtools
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lim_pred_regions.bed > GR_lim_pred_intersect_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lim_pred_regions.bed > GR_lim_pred_intersect_us.bed #######################
...
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lou_dex_regions.bed > GR_lou_dex_intersect_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lou_dex_regions.bed > GR_lou_dex_intersect_us.bed #######################
...
# 
# ############# intersect using bedtools
############# bedtools closest -iu -D a -t first -a enhancers_sort.bed -b GR_lou_WT_regions.bed > GR_lou_WT_intersect_ds.bed #######################
############# bedtools closest -id -D a -t first -a enhancers_sort.bed -b GR_lou_WT_regions.bed > GR_lou_WT_intersect_us.bed #######################
...
save(data_master, file="ChIPtogether_GRdist.RData")
